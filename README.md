...
* ** AI & Data Core (The Brain & Vault):** * **Tech:** Python, LangChain, ChromaDB, Gemini/OpenAI API.
    * **Logic:** Automated Email IMAP parsing converts PDFs to Markdown JSON. LangChain chunks the data via headers, and ChromaDB handles local vector storage with strict metadata filtering to prevent stale data retrieval.
